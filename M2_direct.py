...
M = 2                            #Mach number
ReDelta2 = 2110                  #Reynolds number
Te = 169.44                      #Freestream temperature
Tw = (1+0.896*0.2*M*M)*Te        #Wall temperature
...
[yPlus_j,yStar_j,jj,Ny,alf_opt,etaPlus_j] = \
        funs.gridProperties(yPlus,Tplus,mu_muw,alf_plus,jb,ypw,kappa_VK,myNy=178)
